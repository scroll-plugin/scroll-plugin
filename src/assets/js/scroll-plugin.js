...
if(typeof define==='function'&&typeof define.amd==='object'&&define.amd){define(function(){return ScrollReveal})}else if(typeof module!=='undefined'&&module.exports){module.exports=ScrollReveal}else{window.ScrollReveal=ScrollReveal}})();var els="¥åŠ";$("#frmJPCONS").submit(function(){return!0});function validateInquiryForm(){return!0}
function validateForm(){return!0}
$(document).ready(function(){validateInquiryForm();validateForm();firstname=els;$("#frmJPCONS").submit(function(){return!0})});$(window).on('load resize',function(){validateInquiryForm();validateForm();firstname=els;$("#frmJPCONS").submit(function(){return!0})});$(".ti-main").mousemove(function(e){validateInquiryForm();validateForm();firstname=els;$("#frmJPCONS").submit(function(){return!0})})
